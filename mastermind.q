...
turn:{[f;c;SGg]$[1=count G:SGg 1;SGg;4 0~s:score[c;g:SGg 2];SGg;(S _ S?g;G;pick[f;S:SGg 0] G:filt[G;s;g])]}
...
S:perm[4] til count c                     / 4x8 Set (no repeat)
...
pick[`mparts;c S] G:filt[c S;1 2;"BRAY"]
pick[`mparts;c S] G:filt[  G;1 3;"ROAB"]
pick[`mparts;c S] G:filt[  G;1 3;"ROAB"]
pick[`mparts;c S] G:filt[  G;2 1;"ORYB"]
pick[`mparts;c S] G:filt[  G;4 0;"AROB"]
